...
if __name__ == '__main__':
    ...
    # print("test_SimConfig_path: ", os.path.dirname(os.path.dirname(os.getcwd())))
    _test = tile_latency_analysis(test_SimConfig_path, 189, 2048, 3211264,9547776, 8, 4)
    # print(_test.tile_latency)
    print('transfer_latency: ', _test.transfer_latency)
    print('tile_buf_wlatency: ', _test.tile_buf_wlatency)
    print('PE_latency: ', _test.PE_latency)
    print('jointmodule_latency: ', _test.jointmodule_latency)
    print('tile_latency: ', _test.tile_latency)