...
if __name__ == '__main__':
    ...
    _test = PE_latency_analysis(test_SimConfig_path, 512,512,150528,447552)
    # print(_test)
    print('PE_latency: ', _test.PE_latency)
    print('PE_digital_latency: ', _test.PE_digital_latency)
    print('PE_buf_wlatency: ', _test.PE_buf_wlatency)
    print('PE_buf_rlatency: ', _test.PE_buf_rlatency)
    print('computing_latency: ', _test.computing_latency)