...
if __name__ == '__main__':
    ...
    parser.add_argument('--resource', default=216, type=int, help='Resource limit (default: 60)')
    ...
    transmission_limit = 2100000   # Total data transmission上限
    output_file = "global_" + net + "_mapping_design.csv"
    max_rows = 1000000              # 最大记录数
    timeout_seconds = 600           # 设置超时时间为 10 分钟
