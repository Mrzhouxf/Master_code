from function import * # 假设这里包含了所有的映射和搜索函数
import argparse
import time
import os
import sys
...
NETWORK_LIMITS = {
    ...
    'vgg16': {'cycle': 90000, 'transmission': 40000000, 'resource': 60},
}
...
LOG_FILE = os.path.join(
    LOG_DIR,
    f"{net}_{resource_limit}_{CYCLE_LIMIT}_{TRANSMISSION_LIMIT}_ablation_study_log.txt"
)
